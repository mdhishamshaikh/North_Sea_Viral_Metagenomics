...
#PBS -N metacerberus_all_NJ_PE_GF
...
OUTPUT_DIR="$HOME_DIR/working/9_functional_annotation/2_metacerberus/NJ_PE_GF_metacerberus_all_output"
...
metacerberus.py --protein $GENOMAD_VIRUS_PROTEINS --illumina --meta --hmm ALL --dir_out $OUTPUT_DIR --cpus 40 
