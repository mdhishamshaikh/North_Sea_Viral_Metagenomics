...
#PBS -N PhaGCN2_NJ_PE_GF_gpu
#PBS -l nodes=1:ppn=quarter:gpus=1 #1 of node requested; 20 processors in total
...
OUTPUT_DIR="$HOME_DIR/working/7_bacteriophages/2_phagcn2/NJ_PE_GF_phagcn2_output_gpu"
mkdir -p $OUTPUT_DIR
cd $OUTPUT_DIR
